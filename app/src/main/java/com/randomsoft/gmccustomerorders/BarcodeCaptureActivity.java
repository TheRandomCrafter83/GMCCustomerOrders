...
import com.randomsoft.gmccustomerorders.ui.camera.CameraSource;
import com.randomsoft.gmccustomerorders.ui.camera.CameraSourcePreview;


import com.randomsoft.gmccustomerorders.ui.camera.GraphicOverlay;
...
public class BarcodeCaptureActivity extends AppCompatActivity implements BarcodeGraphicTracker.BarcodeUpdateListener {
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        CameraSource.Builder builder = new CameraSource.Builder(getApplicationContext(), barcodeDetector )
                ...
                .setRequestedPreviewSize(nSize, nSize)
    ...
    private void playBeep(){
        ...
        try{
            ...
            AssetFileDescriptor descriptor  = this.getAssets().openFd(beepSoundFile != null ? beepSoundFile : "beep.mp3");
